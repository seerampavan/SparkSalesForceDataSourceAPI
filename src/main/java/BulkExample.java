...
public class BulkExample {
    ...
    public static void main(String[] args)
        ...
        example.runSample("Account", "venkat@sbit.com", "XXXXXX");
    }
    ...
    public void doBulkQuery(BulkConnection bulkConnection)  throws AsyncApiException, IOException {
        /*if ( ! login() ) {
            return;
        }*/
        try {
            ...
            String query =
                    "select id, name, amount from opportunity";//"SELECT Name, Id, Description__c FROM Merchandise__c";
            ...
            if (queryResults != null) {
                ...
                for (String resultId : queryResults) {
                    CSVReader rdr =
                            new CSVReader(bulkConnection.getQueryResultStream(job.getId(), info.getId(), resultId));
